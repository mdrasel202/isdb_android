...
import com.example.searchapplication.activity.SearchableGridViewActivity;
import com.example.searchapplication.activity.SearchableLastViewActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void openSearchableListView() {
        Intent intent = new Intent(this, SearchableLastViewActivity.class);
        startActivity(intent);
    }
