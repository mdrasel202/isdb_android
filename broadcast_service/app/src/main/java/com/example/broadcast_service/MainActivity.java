package com.example.broadcast_service;
...
import com.example.broadcast_service.service.MyBackGroundService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button startServiceButton = findViewById(R.id.textStarService);
        Button stopServiceButton = findViewById(R.id.textStopService);
        Button sendBroadcastButton = findViewById(R.id.textBroadcast);
